...
public class AppSecSystem {
  ...
  public static void start(SubscriptionService gw, SharedCommunicationObjects sco, Tracer globalTracer) {
    try {
  ...
  private static void doStart(SubscriptionService gw, SharedCommunicationObjects sco, Tracer globalTracer) {
