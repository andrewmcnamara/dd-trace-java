...
public class PowerWAFInitializationResultReporter implements TraceSegmentPostProcessor {
  private final static String RULE_FILE_VERSION = "_dd.appsec.event_rules.version";
  private final static String RULE_ERRORS = "_dd.appsec.event_rules.errors";
  private final static String RULES_LOADED = "dd.appsec.event_rules.loaded";
  private final static String RULE_ERROR_COUNT = "dd.appsec.event_rules.error_count";
  ...
  @Override
  public void processTraceSegment(TraceSegment segment, Collection<AppSecEvent100> collectedEvents) {
